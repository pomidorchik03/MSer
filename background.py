...
from spotify import sp, get_last_release
        ...
        try:
            ...
            for user_id in data:
                ...
                for artist_id in data[user_id]:
                    ...
                    latest_album_id = get_last_release(artist_id)
                ...
                for user_id, artists in news.items():
                    try:
                        await bot.send_message(
                            user_id, "🎉 У ваших любимых артистов вышли новые альбомы!"
                        )
                        for artist_id in artists:
                            artist_info = sp.artist(artist_id)
                            album_info = sp.album(
                                sp.artist_albums(artist_id, limit=1)["items"][0]["id"]
                            )
                            await bot.send_message(
                                user_id,
